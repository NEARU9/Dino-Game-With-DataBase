...
<div id="signin">
    <fieldset>
        ...
        <form name="formSignup" method="post" action="" enctype="multipart/form-data">
            ...
            <input name="signup_username" type="text" id="signup_username" placeholder="Buat Username" required>
            <input name="signup_password" type="password" id="signup_password" placeholder="Buat Password" required>
